...
//! ================================================== SEARCH PROJECT STARTS  ================================================================

const searchFunction = () =>{
    let search = document.getElementById("Search").value.toUppercase();
    let projects = document.getElementById("portfolio-item");

    let projectItems =document.querySelectorAll("portfolio-item-inner")

    let projectName = projects.document.getElementsByTagName("h1")

    for(var i=0;i<projectName;i++) {
      let match = projectItems[i].getElementsByTagName('h1')[0];
